package com.shangji.login.controller;
...
//    }
     ...
     * @CreateDate: 2016-8-28 下午4:30:18
     */
    @RequestMapping("/business/checkLogin")
    public void checkLogin(HttpServletRequest request,
        ...
        try {
            ...
            User user = userService.checkLogin(loginId, passwd);
            if (user == null) {
                resultMap.put(RESULTMAP_KEY_SUCCESS, RESULTMAP_SUCCESS_FALSE);
     ...
     * @CreateDate: 2016-8-28 下午4:30:18
     */
    @RequestMapping("/business/checkCookie")
