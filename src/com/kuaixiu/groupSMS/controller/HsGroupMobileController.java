...
/**
 * HsGroupMobile Controller
 *
 * @CreateDate: 2019-06-19 上午09:22:13
 * @version: V 1.0
 */
@Controller
public class HsGroupMobileController extends BaseController {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "groupSms/toGroupMobile")
    public ModelAndView toGroupMobile(HttpServletRequest request,
                             HttpServletResponse response) throws Exception {

        String returnView = "groupSms/groupMobileList";
     ...
     * @throws Exception
     */
    @RequestMapping(value = "groupSms/groupMobileForPage")
    public void groupMobileForPage(HttpServletRequest request, HttpServletResponse response) throws Exception {
        Page page = getPageByRequest(request);
        HsGroupMobile hsGroupMobile = new HsGroupMobile();
        hsGroupMobile.setPage(page);
        List<HsGroupMobile> hsGroupMobiles = hsGroupMobileService.queryListForPage(hsGroupMobile);
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/groupSms/importMobile")
    public ModelAndView importMobile(HttpServletRequest request,
                              HttpServletResponse response) throws Exception {
        
        String returnView ="groupSms/importMobile";
        return new ModelAndView(returnView);
    }
     ...
     * @author
     */
    @RequestMapping(value = "/groupSms/import")
        ...
        try {
            if (myfile != null && StringUtils.isNotBlank(myfile.getOriginalFilename())) {
                ...
                if (!extension.equalsIgnoreCase("xls")) {
                    ...
                    hsGroupMobileService.importExcel(myfile, report, getCurrentUser(request));
