...
public interface WxMpPayService {
   ...
   * @deprecated Use com.common.wechat.api.WxMpService.getPrepayId(Map<String, String>) instead
   */
  @Deprecated
   ...
   * @param ip         发起支付的客户端IP
   * @param notifyUrl  通知地址
   * @deprecated Use com.common.wechat.api.WxMpService.getPayInfo(Map<String, String>) instead
   */
  @Deprecated
  ...
  /**
   * 拼装JSAPI发起支付请求需要的参数
   * @param prepayId “统一下单”接口返回的prepay_id参数值
   * @return
   * @author: lijx
   * @CreateDate: 2016-10-15 下午9:30:45
   */
   ...
   */
  WxMpPayQueryRefundState queryRefundPay(Map<String, String> parameters) throws WxErrorException;
   ...
   * @return 操作结果
   */
  WxMpPayCloseResult closeOrder(String outTradeNo);
