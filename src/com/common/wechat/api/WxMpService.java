...
public interface WxMpService {
   ...
   * </pre>
   *
   * @see #massGroupMessageSend(com.common.wechat.bean.WxMpMassGroupMessage)
   * @see #massOpenIdsMessageSend(com.common.wechat.bean.WxMpMassOpenIdsMessage)
   */
   ...
   * <pre>
   * 分组群发消息
   * 如果发送图文消息，必须先使用 {@link #massNewsUpload(com.common.wechat.bean.WxMpMassNews)} 获得media_id，然后再发送
   * 如果发送视频消息，必须先使用 {@link #massVideoUpload(com.common.wechat.bean.WxMpMassVideo)} 获得media_id，然后再发送
   * 详情请见: http://mp.weixin.qq.com/wiki/index.php?title=高级群发接口
   * </pre>
   */
   ...
   * 可以参考，{@link com.common.wechat.common.util.http.MediaUploadRequestExecutor}的实现方法
   * </pre>
   */
