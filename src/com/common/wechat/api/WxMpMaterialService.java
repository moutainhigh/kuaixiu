...
import com.common.wechat.common.bean.result.WxMediaUploadResult;
import com.common.wechat.common.exception.WxErrorException;
import com.common.wechat.bean.*;
...
public interface WxMpMaterialService {
   ...
   * </pre>
   *
   * @param mediaType   媒体类型, 请看{@link com.common.wechat.common.api.WxConsts}
   * @param fileType    文件类型，请看{@link com.common.wechat.common.api.WxConsts}
   ...
   *
   * @param mediaType 媒体类型, 请看{@link com.common.wechat.common.api.WxConsts}
   * @param material  上传的素材, 请看{@link com.common.wechat.bean.WxMpMaterial}
   */
   ...
   * </pre>
   *
   * @param news 上传的图文消息, 请看{@link com.common.wechat.bean.WxMpMaterialNews}
   */
   ...
   * </pre>
   *
   * @param wxMpMaterialArticleUpdate 用来更新图文素材的bean, 请看{@link com.common.wechat.bean.WxMpMaterialArticleUpdate}
   */
   ...
   * </pre>
   *
   * @param type   媒体类型, 请看{@link com.common.wechat.common.api.WxConsts}
   * @param offset 从全部素材的该偏移位置开始返回，0表示从第一个素材 返回
   * @param count  返回素材的数量，取值在1到20之间
   */
