...
public class JsonUtil {
	...
	public static void main(String[] args) throws Exception {
		//获取 string类型
	    Object obj = JsonUtil.getObjectByJson(jsonStr,"response.data.ptitle",TypeEnum.string); //层级递归String
		System.out.println("String:"+obj.toString());
		//获取 map类型
		Object objs = JsonUtil.getObjectByJson(jsonStr,"response.page",TypeEnum.map);  //层级递归Map
		System.out.println("Map:"+objs.toString()+"   "+((Map)objs).get("pageSize"));
		//获取arraylist类型
		Object list = JsonUtil.getObjectByJson(jsonStr, "args", TypeEnum.arrayList);
