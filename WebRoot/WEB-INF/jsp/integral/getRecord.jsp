...
<div class="body_cont">
	...
	<div class="new_order graybg" style="position:relative;">
      ...
      <!-- 积分显示记录模板 -->
   	  <div class="record_list new_input" id="template" style="display: none;">
		 	  	   <div class="half_cont">
			 	  		<p class="time">时间</p>
			 	   </div>
			 	   <div class="half_cont txtright">
			 	  		<p class="audit_state">获得100分</p>
			 	   </div>
	 </div>
...
function searchOrderList(upOrdown) {//上拉事件  
	  $.ajax({
	        type: "POST",
	        url: AppConfig.ctx +"/wap/integral/addRecord.do",
	        data: {
	            "start": start,
	            "length": length
	        },
...
function eachFull(info) {
    $.each(info, function (i, n) {
         ...
         $(".audit_state", tmp).text('获得'+n.integral+'分');
          //追加到对应区块
