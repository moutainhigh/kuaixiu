...
<script type="text/javascript">
    ...
    function addBtnClick() {
        ...
        $("#modal-insertView").load("${ctx}/groupShort/toAddAddress.do", function () {
    ...
    function editBtnClick(id) {
        $("#modal-editView").html("");
        $("#modal-editView").load("${ctx}/groupShort/toEditAddress.do?id="+id, function () {
            func_after_model_load(this);
        });
    }
    ...
    //设置数据刷新路径
    dto.ajax = {
        "url": "${ctx}/groupShort/addressListForPage.do",
        "data": function (d) {
            //将表单中的查询条件追加到请求参数中
    ...
    function delBtnClick(id) {
        AlertText.tips("d_confirm", "删除提示", "确定要删除吗？", function () {
            ...
            var url_ = AppConfig.ctx + "/groupShort/delAddress.do";
            var data_ = {id: id};
            $.ajax({
                url: url_,
                data: data_,
