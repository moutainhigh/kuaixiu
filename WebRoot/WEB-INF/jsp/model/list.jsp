...
<%@ include file="/commons/taglibs.jsp" %>
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf" style="width: 100%;">
          <strong class="am-text-primary am-text-lg">维修机型管理</strong> / <small>列表查询</small>
        </div>
      </div>
		  ...
		  <div class="am-form-group">
		    ...
		    <div class="am-u-sm-12 am-u-md-4">
		      <div class="am-input-group am-input-group-sm">
		        ...
		        <input type="text" onkeydown="refreshPage()" name="query_name" class="am-form-field" placeholder="机型名称" >
            ...
            <table id="dt" class="table table-striped table-bordered table-radius table-hover">
              <thead>
	            <tr>
                  ...
                  <th class="fontWeight_normal table-title">支持项目</th>
	              <th class="fontWeight_normal tdwidth140 am-hide-sm-only">添加时间</th>
...
//设置数据刷新路径
dto.ajax={
	    "url": "${ctx}/model/queryListForPage.do",
		"data":function(d){
			//将表单中的查询条件追加到请求参数中
...
dto.setColumnDefs([
    ...
    {//支持项目
        targets: -3,
        render: function (data, type, row, meta) {
            var repairCosts = row.repairCosts;
            var html = "";
            if(repairCosts){
            	$.each(repairCosts, function (i, value) {
            		if(i > 0){
            			html += "、";
            		}
...
function addBtnClick(){
    ...
    $("#modal-insertView").load("${ctx}/model/add.do", function(){
...
function editBtnClick(id){
    ...
    $("#modal-updateView").load("${ctx}/model/edit.do?id="+id, function(){
    	func_after_model_load(this);
    });
}
/**
...
function delBtnClick(id){
	AlertText.tips("d_confirm", "删除提示", "确定要删除吗？", function(){
		...
		var url_ = AppConfig.ctx + "/model/delete.do";
	    var data_ = {id: id};
	    $.ajax({
	        url: url_,
	        data: data_,
