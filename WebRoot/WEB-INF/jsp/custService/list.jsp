...
<div class="am-cf am-padding am-padding-bottom-0">
    <div class="am-fl am-cf" style="width: 100%;">
        <strong class="am-text-primary am-text-lg">客服管理</strong> /
        <small>列表查询</small>
    </div>
</div>
    ...
    <div class="am-u-sm-12">
        <table id="dt" class="table table-striped table-bordered table-radius table-hover">
            ...
            <tr>
                ...
                <th class="fontWeight_normal  center">姓名</th>
                <th class="fontWeight_normal  center">手机号</th>
                <th class="fontWeight_normal tdwidth80 center">性别</th>
...
<script type="text/javascript">
    ...
    //设置数据刷新路径
    dto.ajax = {
        "url": "${ctx}/custService/queryListForPage.do",
        "data": function (d) {
            //将表单中的查询条件追加到请求参数中
    ...
    function toDetail(id) {
        func_reload_page("${ctx}/custService/detail.do?id=" + id);
    }

    function addBtnClick() {
        $("#modal-insertView").html("");
        $("#modal-insertView").load("${ctx}/custService/add.do", function () {
    ...
    function editBtnClick(id) {
        $("#modal-insertView").html("");
        $("#modal-insertView").load("${ctx}/custService/edit.do?id=" + id, function () {
            func_after_model_load(this);
        });
    }
    ...
    function delBtnClick(id) {
        AlertText.tips("d_confirm", "删除提示", "确定要删除吗？", function () {
            ...
            var url_ = AppConfig.ctx + "/custService/delete.do";
            var data_ = {id: id};
            $.ajax({
                url: url_,
                data: data_,
