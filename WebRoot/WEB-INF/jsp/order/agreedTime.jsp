    ...
    <div class="modal-body">
      <form id="insertForm" method="post" class="form-horizontal">
        ...
        <div class="form-group">
          <label for="agreedTime" class="col-sm-3 control-label"><span style="color:red">*</span> 预约时间</label>
          <div class="col-sm-7">
            <input type="text" id="agreedTime" name="agreedTime" class="form-control" placeholder="请选择预约时间">
          </div>
        </div>
        <div class="form-group">
          <label for="agreedTime" class="col-sm-3 control-label"><span style="color:red">*</span> 预约备注</label>
          <div class="col-sm-7">
            <textarea name="agreedNote" id="" cols="50" rows="10"  placeholder="请选择预约备注，仅限250字"></textarea>
            <%--<input type="text" id="agreedNote" name="agreedNote" class="form-control" placeholder="请选择预约备注">--%>
          </div>
        </div>
