...
<%@ include file="/commons/taglibs.jsp" %>
      ...
      <div class="am-g">
	    <form id="searchForm" class="form form-horizontal">
	      ...
	      <input type="hidden" name="query_orderStates" value="5,20">
    ...
    <select id="engSelectTemp" style="display: none;">
        ...
        <c:forEach items="${row.engineerList}" var="item" varStatus="i" >
...
dto.setColumnDefs([
 ...
 
    {
        ...
        render: function (data, type, row, meta) {
            ...
            var info=row.engineerList;
            $.each(info, function (i, n) {
            	var html='';
            	if(n.id==row.engineerId){
...
$(function(){
	...
	$("#engSelect_").change(function(){
		alert($("#engSelect_  option:selected").val());
		});
