...
<div class="am-g">
    <form id="searchForm" class="form form-horizontal">
        <table id="searchTable">
            ...
            <tr>
                <td class="search_th search_th_frist"><label class="control-label">维修机型：</label></td>
                <td class="search_td"><input type="text" name="query_model" class="form-control"></td>
            ...
            <tr>
                <td class="search_th_frist"><label class="control-label">门店名称：</label></td>
                <td class="search_td"><input type="text" name="query_shopName" class="form-control"></td>
                <td class="search_th"><label class="control-label">门 店 账 号 ：</label></td>
                <td class="search_td"><input type="text" name="query_shopCode" class="form-control"></td>
                <td class="search_th"><label class="control-label">负责人电话：</label></td>
                <td class="search_td">
                    <input type="text" name="query_shopManagerMobile" class="form-control">
                </td>
            </tr>
            <tr>
                <td class="search_th search_th_frist"><label class="control-label">结算状态：</label></td>
                <td class="search_td">
