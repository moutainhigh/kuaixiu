...
<div class="am-cf am-padding am-padding-bottom-0">
	<div class="am-fl am-cf" style="width: 100%;">
		<strong class="am-text-primary am-text-lg"><a
			href="javascript:void(0);" onclick="toList();">返修订单管理</a></strong> / <small>返修订单详情</small>
	</div>
</div>
...
<div class="am-g">
	<div class="panel panel-success index-panel-msg">
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>维修方式：${eng.number }</h4>
			</div>
			<!-- /.col -->
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>维修单位：${eng.idcard }</h4>
			</div>
			<!-- /.col -->
		</div>
		<!-- /.row -->
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>预约时间：${eng.number }</h4>
			</div>
			<!-- /.col -->
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>完成时间：${eng.idcard }</h4>
			</div>
			<!-- /.col -->
		</div>
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>打卡时间：${eng.number }</h4>
			</div>
			<!-- /.col -->
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>打卡地址：${eng.idcard }</h4>
			</div>
			<!-- /.col -->
		</div>
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>母订单号：${eng.number }</h4>
			</div>
			<!-- /.col -->
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>上次维修人员：${eng.idcard }</h4>
			</div>
			<!-- /.col -->
		</div>
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<h4>维修人员：${eng.number }</h4>
			</div>
