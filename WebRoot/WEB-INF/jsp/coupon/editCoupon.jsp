        ...
        <div class="modal-body">
            <form id="insertForm" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="addName" class="col-sm-2 control-label"> 优惠券号码</label>
                    <div class="col-sm-9">
                        <p class="form-control-static">${coupon.couponCode }</p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <c:if test="${coupon.type==0 }">
                    <div class="form-group">
                        ...
                        <input id="checkAll_brand" type="hidden" name="checkAllBrand"
                               value="${coupon.isBrandCurrency}"/>
                        <div class="col-sm-9">
                            <input id="check_all_brand" ${coupon.isBrandCurrency == 1 ? 'checked="checked"' : '' }
                                   style="position: relative;top:6px;" onclick="checkAllBrands(this)" type="checkbox"/>
                            <span style="position: relative;top:5px;">全选</span>
                    ...
                    <div class="form-group">
                        ...
                        <input id="checkAll_project" type="hidden" name="checkAllProject"
                               value="${coupon.isProjectCurrency}"/>
                        <div class="col-sm-9">
                            <input id="check_all_btn_1" style="position: relative;top:6px;" onclick="checkAll(this)"
...
<script type="text/javascript">
    ...
    function checkAll(obj) {
        ...
        var isTrue = $("#check_all_btn_1").prop("checked");
        if (isTrue == true) {
