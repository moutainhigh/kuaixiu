        ...
        <div class="modal-body">
            <form id="insertForm" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="title"  value="${hsActivityCoupon.title }" style="width:400px;" name="title"
                               class="form-control"
                               placeholder="页面标题名称">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="titleColor" value="${hsActivityCoupon.titleColor }"  style="width:400px;" name="titleColor"
                               class="form-control"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="buttonColor" value="${hsActivityCoupon.buttonColor }"  style="width:400px;" name="buttonColor"
                               class="form-control"
                               placeholder="按钮背景颜色">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="buttonCodeColor" value="${hsActivityCoupon.buttonCodeColor }"  style="width:400px;" name="buttonCodeColor"
                               class="form-control"
                               placeholder="按钮文字颜色">
                    </div>
                </div>
