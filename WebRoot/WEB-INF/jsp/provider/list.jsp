...
<div class="am-cf am-padding am-padding-bottom-0">
    <div class="am-fl am-cf" style="width: 100%;">
        <strong class="am-text-primary am-text-lg">连锁商管理</strong> /
        <small>列表查询</small>
    </div>
</div>
        ...
        <div class="am-form-group">
            ...
            <div class="am-u-sm-12 am-u-md-4">
                ...
                <div class="am-input-group am-input-group-sm">
                    <input type="text" onkeydown="refreshPage()" name="query_name" class="am-form-field" placeholder="连锁商名称">
    ...
    <div class="am-u-sm-12">
        <table id="dt" class="table table-striped table-bordered table-radius table-hover">
            ...
            <tr>
                ...
                <th class="fontWeight_normal tdwidth100">连锁商名称</th>
                <th class="fontWeight_normal tdwidth80">连锁商账号</th>
                <th class="fontWeight_normal tdwidth140">负责人/手机号</th>
                <th class="fontWeight_normal table-title">地址</th>
                <th class="fontWeight_normal tdwidth100">电话</th>
...
<script type="text/javascript">
    ...
    //设置数据刷新路径
    dto.ajax = {
        "url": "${ctx}/provider/queryListForPage.do",
        "data": function (d) {
            //将表单中的查询条件追加到请求参数中
    ...
    function addBtnClick() {
        ...
        $("#modal-insertView").load("${ctx}/provider/add.do", function () {
            /* if($("#modal-insertView").html() != ""){
             $("#modal-insertView").modal("show");
             $("#modal-insertView").css("display", "block");
             $("#modal-insertView").addClass("in");
             } */
            //console.log("ss");
    ...
    function editBtnClick(id) {
        $("#modal-insertView").html("");
        $("#modal-insertView").load("${ctx}/provider/edit.do?id=" + id, function () {
            func_after_model_load(this);
        });
    }
    /**
    ...
    function expDataExcel() {
        ...
        window.open("${ctx}/file/download.do?fileId=2&ids=" + ids + params, "导出");
    }
    /**
     * 批量删除
     */
    ...
    function delBtnClick(id) {
        AlertText.tips("d_confirm", "删除提示", "确定要删除吗？", function () {
            ...
            var url_ = AppConfig.ctx + "/provider/delete.do";
            var data_ = {id: id};
            $.ajax({
                url: url_,
                data: data_,
