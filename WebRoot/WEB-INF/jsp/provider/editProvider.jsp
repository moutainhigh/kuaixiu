...
<div class="modal-dialog" style="width: 700px;">
  <div class="modal-content">
    <div class="modal-title"><span>编辑连锁商</span>
    ...
    <div class="modal-body">
      <form id="insertForm" method="post" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" id="addName" name="addName" value="${provider.name }" class="form-control" placeholder="请输入连锁商名称">
          </div>
        </div>
        <div class="form-group">
          <label for="addManagerName" class="col-sm-3 control-label"><span style="color:red">*</span> 负责人姓名</label>
          <div class="col-sm-9">
            <input type="text" id="addManagerName" name="addManagerName" value="${provider.managerName }" class="form-control" placeholder="请输入负责人姓名">
          </div>
        </div>
        <div class="form-group">
          <label for="addManagerMobile" class="col-sm-3 control-label"><span style="color:red">*</span> 负责人手机号</label>
          <div class="col-sm-9">
            <input type="text" id="addManagerMobile" name="addManagerMobile" value="${provider.managerMobile }" class="form-control" placeholder="请输入负责人手机号">
          </div>
        </div>
        <div class="form-group">
          <label for="addTel" class="col-sm-3 control-label"><span style="color:red">*</span> 连锁商电话号码</label>
          <div class="col-sm-9">
            <input type="text" id="addTel" name="addTel" value="${provider.tel }" class="form-control" placeholder="请输入连锁商电话号码">
          </div>
        </div>
        <div class="form-group">
          <label for="addAccountBank" class="col-sm-3 control-label"><span style="color:red">*</span> 连锁商开户银行</label>
          <div class="col-sm-9">
            <input type="text" id="addAccountBank" name="addAccountBank" value="${provider.accountBank }" class="form-control" placeholder="请输入连锁商开户银行">
          </div>
        </div>
        <div class="form-group">
          <label for="addAccountBankBranch" class="col-sm-3 control-label"><span style="color:red">*</span> 连锁商开户银行支行</label>
          <div class="col-sm-9">
            <input type="text" id="addAccountBankBranch" name="addAccountBankBranch" value="${provider.accountBankBranch }" class="form-control" placeholder="请输入连锁商开户银行支行">
          </div>
        </div>
        <div class="form-group">
          <label for="addAccountName" class="col-sm-3 control-label"><span style="color:red">*</span> 连锁商开户户名</label>
          <div class="col-sm-9">
            <input type="text" id="addAccountName" name="addAccountName" value="${provider.accountName }" class="form-control" placeholder="请输入连锁商开户户名">
          </div>
        </div>
        <div class="form-group">
          <label for="addAccountNumber" class="col-sm-3 control-label"><span style="color:red">*</span> 连锁商开户账号</label>
          <div class="col-sm-9">
            <input type="text" id="addAccountNumber" name="addAccountNumber" value="${provider.accountNumber }" class="form-control" placeholder="请输入连锁商开户账号">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <div class="input-group">
              <input type="text" id="addProportion" name="addProportion" value="${provider.proportion * 100 }" class="form-control" placeholder="请输入手续费扣除比例">
          ...
          <div class="col-sm-9">
            <select id="addProvince" name="addProvince" onchange="fn_select_address(2, this.value, '', 'add');" class="form-control-inline">
              ...
              <c:forEach items="${provinceL }" var="item" varStatus="i">
                <option value="${item.areaId }" ${item.areaId == provider.province ? 'selected="selected"' : '' }>${item.area }</option>
              </c:forEach>
            </select>
            ...
            <select id="addCity" name="addCity" onchange="fn_select_address(3, this.value, '', 'add');" class="form-control-inline">
              ...
              <c:forEach items="${cityL }" var="item" varStatus="i">
                <option value="${item.areaId }" ${item.areaId == provider.city ? 'selected="selected"' : '' }>${item.area }</option>
              </c:forEach>
            </select>
            ...
            <select id="addCounty" name="addCounty" onchange="fn_select_address(4, this.value, '', 'add');" class="form-control-inline">
              ...
              <c:forEach items="${countyL }" var="item" varStatus="i">
                <option value="${item.areaId }" ${item.areaId == provider.county ? 'selected="selected"' : '' }>${item.area }</option>
              </c:forEach>
            </select>
            ...
            <select id="addStreet" name="addStreet" class="form-control-inline" style="${empty streetL ? 'display: none;' : '' }">
              ...
              <c:forEach items="${streetL }" var="item" varStatus="i">
                <option value="${item.areaId }" ${item.areaId == provider.street ? 'selected="selected"' : '' }>${item.area }</option>
              </c:forEach>
            </select>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-9 col-sm-offset-3">
            <input type="text" id="addAddress" name="addAddress" value="${provider.address }" class="form-control" placeholder="请输入详细地址">
          </div>
        </div>
