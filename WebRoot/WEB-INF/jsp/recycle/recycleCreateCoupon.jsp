...
<script src="${webResourceUrl}/resource/js/address.js" type="text/javascript" charset="utf-8"></script>
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf" style="width: 100%;">
          <strong class="am-text-primary am-text-lg"><a href="javascript:void(0);"  onclick="toList();">加价券管理</a></strong> / <small>生成优惠券</small>
        </div>
      </div>
      ...
      <div class="am-g">
        ...
        <form id="insertForm" method="post" class="form-horizontal">
            ...
            <div class="form-group" id="prices">
                ...
                <div class="col-sm-9">
                    <input type="text" id="ruleDescription" name="ruleDescription" class="form-control" placeholder="请输入加价券规则描述">
                </div>
            </div>
            <div class="form-group" id="projects">
	        ...
	        <div class="form-group" id="prices">
	          <label for="couponPrice" class="col-sm-2 control-label"><span style="color:red">*</span> 加价券金额。如果是百分比加价：无需输入百分号，输入分子即可</label>
	          <div class="col-sm-9">
        	...
        	<div class="form-group" id="projects">
	          ...
	          <div class="col-sm-9">
	            <input type="text" id="count" name="number" class="form-control" maxlength="5" placeholder="请输入本次生成数量，最大支持一次生成10000张加价券">
	          </div>
	        </div>
...
$(function(){
	 ...
	 $("input:radio[name=chooseCoupon]").change(function(){
		 ...
		 if(choose==0){    //维修
			 ...
			 $("#tip").show();
			 $("#screen_tip").hide();
			 $("input[name='addBrand']").each(function(){this.checked=false;}); 
			 $("input[name='addProject']").each(function(){this.checked=false;}); 
			 $("#supportBrands").hide();
