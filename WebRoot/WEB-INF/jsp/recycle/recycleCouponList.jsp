...
<%@ include file="/commons/taglibs.jsp" %>
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf" style="width: 100%;">
          <strong class="am-text-primary am-text-lg">加价券管理</strong> / <small>列表查询</small>
        </div>
      </div>
      ...
      <div class="am-g">
	    <form id="searchForm" class="am-form am-form-horizontal">
		  <div class="am-form-group">
		    <div class="am-u-sm-12 am-u-md-5">
		      <div class="am-btn-toolbar">
		        <div class="am-btn-group am-btn-group-sm">
		          <button onclick="createCoupon();" type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 生成加价券</button>
		          ...
		          <button onclick="delByBatchIdBtnClick();" type="button" class="am-btn am-btn-default"><span class="am-icon-trash-o"></span> 按批次删除</button>
		          <button onclick="editByBatchIdBtnClick();" type="button" class="am-btn am-btn-default"><span class="am-icon-pencil-square-o"></span> 按批次编辑</button>
		        </div>
		      </div>
		    </div>
		    <div class="am-u-sm-12 am-u-md-1 col-sm-offset-1" style="padding: 0px 5px;">
		      <div class="am-input-group am-input-group-sm">
		      	<input type="text" name="batchId" class="am-form-field" style="float: left;" placeholder="批次" >
		      </div>
		    </div>
		    <div class="am-u-sm-12 am-u-md-1" style="padding: 0px 5px;">
		      <div class="am-input-group am-input-group-sm">
                <select name="isUse" class="am-form-field">
		    ...
		    <div class="am-u-sm-12 am-u-md-1" style="padding: 0px 5px;">
		      <div class="am-input-group am-input-group-sm">
		      	<select name="isReceive" class="am-form-field">
		    ...
		    <div class="am-u-sm-12 am-u-md-2" style="padding-left: 5px; padding-right: 3px;">
		      <div class="am-input-group am-input-group-sm">
		        <input type="text" name="couponCode" class="am-form-field" style="float: left;" placeholder="加价编码" >
            ...
            <table id="dt" class="table table-striped table-bordered table-radius table-hover">
              <thead>
	            <tr>
                  ...
                  <th class="fontWeight_normal tdwidth80 center">加价券编码</th>
...
//设置数据刷新路径
dto.ajax={
	    "url": "${ctx}/recycle/getCouponListForPage.do",
		"data":function(d){
			//将表单中的查询条件追加到请求参数中
    ...
    },
	{
	    ...
	    render: function (data, type, row, meta) {
	    	if(row.isUse == 1){
	    		var context = {
		            func: [
		                {"name" : "查看", "fn" : "editBtnClick(\'" + row.id + "\')","icon" : "am-icon-search","class" : "am-text-secondary"}, 
		            ]
		        };
...
function editBtnClick(id){
    ...
    $("#modal-insertView").load("${ctx}/recycle/selectById.do?id="+id, function(){
...
function delByBatchId(batchId){
	AlertText.tips("d_confirm", "按批次删除", "确定要删除当前批次吗？确定后会删除当前批次未使用的优惠券。", function(){
		...
		var url_ = AppConfig.ctx + "/recycle/delete.do";
...
function editByBatchId(batchId){
    $("#modal-insertView").html("");
    $("#modal-insertView").load("${ctx}/recycle/selectBatch.do?batchId="+batchId, function(){
    	func_after_model_load(this);
    });
}
