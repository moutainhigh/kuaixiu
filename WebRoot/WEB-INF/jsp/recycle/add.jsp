...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-title"><span>新增来源系统</span>
      <a href="javascript: void(0);" class="close" data-dismiss="modal" aria-label="Close">&times;</a>
    </div>
    <div class="modal-body">
      <form id="insertForm" method="post" class="form-horizontal">
        <div class="form-group">
          <label for="addName" class="col-sm-3 control-label"><span style="color:red">*</span> 来源系统名称</label>
          <div class="col-sm-8">
...
function insertValidatorForm() {
    $("#insertForm")
        .bootstrapValidator({
            ...
            //遮盖层
            var options = {
                url : "${ctx}/recycle/recycleSystem/save.do",
                dataType : "JSON",
