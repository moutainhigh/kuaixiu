...
<%@ include file="/commons/taglibs.jsp" %>
      ...
      <div class="am-g">
	    <form id="searchForm" class="form form-horizontal">
          <input type="hidden" name="query_orderState" value="2">
          <!--  
            ...
            <table id="dt" class="table table-striped table-bordered table-radius table-hover">
              <thead>
	            <tr>
                  ...
                  <th class="fontWeight_normal ">订单地址</th>
                  <th class="fontWeight_normal ">待派单门店</th>
                  <th class="fontWeight_normal tdwidth60">门店电话</th>
                  <th class="fontWeight_normal table-title tdwidth110">门店负责人姓名/<br/>手机号</th>
                  <th class="fontWeight_normal tdwidth60">空闲工程师人数</th>
                  <th class="fontWeight_normal tdwidth60">派单剩余时间</th>
	              <th class="fontWeight_normal tdwidth60">订单已等待时间</th>
	            </tr>
              </thead>
              <tbody>
