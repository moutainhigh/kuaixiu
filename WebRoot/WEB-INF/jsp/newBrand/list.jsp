...
<%@ include file="/commons/taglibs.jsp" %>
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf" style="width: 100%;">
          <strong class="am-text-primary am-text-lg">新机型管理</strong> / <small>品牌列表</small>
        </div>
      </div>
            ...
            <table id="dt" class="table table-striped table-bordered table-radius table-hover">
              <thead>
	            <tr>
	              ...
	              <th class="fontWeight_normal tdwidth150 center">品牌名称</th>
...
//设置数据刷新路径
dto.ajax={
	    "url": "${ctx}/newBrand/queryListForPage.do",
		"data":function(d){
			//将表单中的查询条件追加到请求参数中
...
function editBtnClick(id){
    ...
    $("#modal-updateView").load("${ctx}/newBrand/edit.do?id="+id, function(){
...
function delBtnClick(id){
	AlertText.tips("d_confirm", "删除提示", "确定要删除吗？", function(){
		...
		var url_ = AppConfig.ctx + "/newBrand/delete.do";
	    var data_ = {id: id};
	    $.ajax({
	        url: url_,
	        data: data_,
