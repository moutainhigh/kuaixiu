...
<div class="am-g">
    ...
    <form id="insertForm" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="companyName" value="${activity.companyName}" name="companyName"
                       class="form-control">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="kxBusinessTitle" name="kxBusinessTitle" value="${activity.kxBusinessTitle}"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="kxBusinessDetail" name="kxBusinessDetail" value="${activity.kxBusinessDetail}"
                       class="form-control" placeholder="快修业务">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" value="${activity.dxIncrementBusinessTitle}" name="dxIncrementBusinessTitle"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea name=" dxIncrementBusiness" id="dxIncrementBusiness" cols="30"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="dxIncrementBusinessDetail" value="${activity.dxIncrementBusinessDetail}"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="dxBusinessPerson" value="${activity.dxBusinessPerson}" name="dxBusinessPerson"
                       class="form-control" placeholder="快修业务">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="dxBusinessPersonNumber" value="${activity.dxBusinessPersonNumber}"
