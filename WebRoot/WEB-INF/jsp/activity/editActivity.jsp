...
<div class="am-g">
    ...
    <form id="insertForm" method="post" class="form-horizontal" enctype="multipart/form-data">
        <input type="hidden" id="activityIdentification" value="${activity.activityIdentification}"
               name="activityIdentification" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" style="width:400px;" id="companyName" value="${activity.companyName}" name="companyName"
                       class="form-control">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" style="width:400px;" id="kxBusinessTitle" name="kxBusinessTitle" value="${activity.kxBusinessTitle}"
                       class="form-control" placeholder="快修业务">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><span style="color:red">*</span>快修业务说明</label>
            <div class="col-sm-9">
                <textarea style="width:400px;" name="kxBusiness" id="kxBusiness" cols="30" rows="10">${activity.kxBusiness}</textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><span style="color:red">*</span>快修活动页地址</label>
            <div class="col-sm-9">
                <input style="width:400px;" type="text" id="kxBusinessDetail" name="kxBusinessDetail" value="${activity.kxBusinessDetail}"
                       class="form-control" placeholder="快修业务">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input style="width:400px;" type="text" value="${activity.dxIncrementBusinessTitle}" name="dxIncrementBusinessTitle"
                       id="dxIncrementBusinessTitle" class="form-control" placeholder="电信业务">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <textarea style="width:400px;" name=" dxIncrementBusiness" id="dxIncrementBusiness" cols="30"
                          rows="10">${activity.dxIncrementBusiness}</textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label"><span style="color:red">*</span>电信活动页地址</label>
            <div class="col-sm-9">
                <input style="width:400px;" type="text" id="dxIncrementBusinessDetail" value="${activity.dxIncrementBusinessDetail}"
                       name="dxIncrementBusinessDetail" class="form-control" placeholder="快修业务">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">电信活动负责人</label>
            <div class="col-sm-9">
                <input style="width:400px;" type="text" id="dxBusinessPerson" value="${activity.dxBusinessPerson}" name="dxBusinessPerson"
                       class="form-control" placeholder="快修业务">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input style="width:400px;" type="text" id="dxBusinessPersonNumber" value="${activity.dxBusinessPersonNumber}"
                       name="dxBusinessPersonNumber" class="form-control" placeholder="快修业务">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">活动时间</label>
            <div class="col-sm-9">
                <input type="text" style="width:400px;" id="activityTime" name="activityTime" value="${activity.activityTime}"
