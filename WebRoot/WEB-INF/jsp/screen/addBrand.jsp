  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form id="insertForm" method="post" class="form-horizontal">
        ...
        <div class="form-group">
          <label for="addMaxPrice" class="col-sm-2 control-label">最高保额</label>
          <div class="col-sm-10">
            <input type="text" id="addMaxPrice" name="addMaxPrice" class="form-control" placeholder="请输入金额 单位（元）" >
          </div>
        </div>
