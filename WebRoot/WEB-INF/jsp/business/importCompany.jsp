...
<link rel="stylesheet" href="${webResourceUrl}/resource/order/css/order.detail.css">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf" style="width: 100%;">
          <strong class="am-text-primary am-text-lg">商机企业管理</strong> / <small>批量导入</small>
        </div>
      </div>
      ...
      <div class="am-g">
	    <form id="importForm" class="form-horizontal" role="form">
	      ...
	      <div class="form-group">
            ...
            <div class="col-sm-9">
              <p class="form-control-static">1、点击 <a href="${ctx}/sj/file/download.do?fileId=29" target="_blank">这里</a> 打开Excel表格，在Excel表格中录入数据。</p>
            </div>
          </div>
          <div class="form-group">
