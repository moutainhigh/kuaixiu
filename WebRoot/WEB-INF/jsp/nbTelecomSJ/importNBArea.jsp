...
<link rel="stylesheet" href="${webResourceUrl}/resource/order/css/order.detail.css">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf" style="width: 100%;">
          <strong class="am-text-primary am-text-lg">支局包区管理</strong> / <small>批量导入</small>
        </div>
      </div>
		  ...
		  <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-9 col-sm-offset-3">
                    <p class="form-control-static">2、导入编辑数据时，根据县分，支局，包区，编辑。当三者与原数据不一样时会新增数据。</p>
                </div>
            </div>
	      <div class="form-group">
            <label class="col-sm-3 control-label">步骤：</label>
            <div class="col-sm-9">
              <p class="form-control-static">1、点击 <a href="${ctx}/file/download.do?fileId=27" target="_blank">这里</a> 打开Excel表格，在Excel表格中录入数据。</p>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-9 col-sm-offset-3">
...
function uploadModelExcel(){
    ...
    $.ajaxFileUpload({
        url: "${ctx}/nbTelecomSJ/importNBArea.do",
        type: "post",
