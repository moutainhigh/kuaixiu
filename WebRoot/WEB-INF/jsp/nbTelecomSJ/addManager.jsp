    ...
    <div class="modal-body">
      <form id="insertForm" method="post" class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input type="text" id="addName" name="managerName" class="form-control" placeholder="姓名">
          </div>
        </div>
        <div class="form-group">
          <label for="addManagerMobile" class="col-sm-3 control-label"><span style="color:red">*</span> 电话</label>
          <div class="col-sm-9">
            <input type="text" id="addManagerMobile" name="managerTel" class="form-control" placeholder="电话">
          </div>
        </div>
        <div class="form-group">
          <label for="addManagerName" class="col-sm-3 control-label"><span style="color:red">*</span> 部门</label>
          <div class="col-sm-9">
            <input type="text" id="addManagerName" name="department" class="form-control" placeholder="部门">
          </div>
        </div>
...
function insertValidatorForm() {
    $("#insertForm")
        .bootstrapValidator({
            ...
            //遮盖层
            var options = {
                url : "${ctx}/nbTelecomSJ/addManager.do",
                dataType : "JSON",
