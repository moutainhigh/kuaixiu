...
<%@ include file="/commons/taglibs.jsp" %>
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf" style="width: 100%;">
          <strong class="am-text-primary am-text-lg">标签管理</strong> / <small>订单取消原因标签列表</small>
        </div>
      </div>
	    ...
	    <form id="searchForm" class="am-form am-form-horizontal">
		  ...
		  <!--         <button onclick="batchDelBtnClick();" type="button" class="am-btn am-btn-default"><span class="am-icon-trash-o"></span> 删除</button> -->
		    ...
		    <div class="am-u-sm-12 am-u-md-4">
		      ...
		      <!--  
		       <input type="text" name="query_name" class="am-form-field" placeholder="品牌名称" >
		       -->
		       <!-- 
            ...
            <table id="dt" class="table table-striped table-bordered table-radius table-hover">
              <thead>
	            <tr>
	              ...
	              <th class="fontWeight_normal table-title center">取消原因</th>
    ...
    <div id="modal-insertView" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
      <%@ include file="addCancelReason.jsp" %>
    </div>
    <!-- 新增弹窗 end -->
    <!-- 修改弹窗 end -->
...
//设置数据刷新路径
dto.ajax={
	    "url": "${ctx}/resource/queryListForPage.do",
		"data":function(d){
			//将表单中的查询条件追加到请求参数中
...
function editBtnClick(id){
    ...
    $("#modal-updateView").load("${ctx}/resource/edit.do?id="+id, function(){
...
function delBtnClick(id){
	AlertText.tips("d_confirm", "删除提示", "确定要删除吗？", function(){
		...
		var url_ = AppConfig.ctx + "/resource/delete.do";
	    var data_ = {id: id};
	    $.ajax({
	        url: url_,
	        data: data_,
