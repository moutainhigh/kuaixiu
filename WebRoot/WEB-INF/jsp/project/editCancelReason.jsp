...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-title"><span>修改标签</span>
    ...
    <div class="modal-body">
      <form id="updateForm" method="post" class="form-horizontal">
        ...
        <div class="form-group">
          <label for="upName" class="col-sm-2 control-label"><span style="color:red">*</span> 取消原因内容</label>
          <div class="col-sm-10">
            <input type="text" id="upName" name="upName" value="${cancelReason.reason }" class="form-control" placeholder="请输入取消原因内容">
          </div>
        </div>
        <div class="form-group">
          <label for="upSort" class="col-sm-2 control-label">排序</label>
          <div class="col-sm-10">
            <input type="text" id="upSort" name="upSort" class="form-control" value="${cancelReason.sort }" placeholder="请输入显示序号" value="${brand.sort }">
          </div>
        </div>
