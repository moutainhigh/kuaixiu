...
<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-title"><span>修改维修项目</span>
    ...
    <div class="modal-body">
      <form id="updateForm" method="post" class="form-horizontal">
        ...
        <div class="form-group">
          <label for="upName" class="col-sm-3 control-label"><span style="color:red">*</span> 维修项目名称</label>
          <div class="col-sm-9">
            <input type="text" id="upName" name="upName" value="${project.name }" class="form-control" placeholder="请输入维修项目名称">
          </div>
        </div>
