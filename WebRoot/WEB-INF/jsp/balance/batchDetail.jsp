...
<%@ include file="/commons/taglibs.jsp" %>
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf" style="width: 100%;">
          <strong class="am-text-primary am-text-lg">对账管理</strong> / <small>批次详情</small>
        </div>
      </div>
      ...
      <div class="am-g">
	    <form id="searchForm" class="form form-horizontal">
		  <div class="form-group">
		    <input type="hidden" name="batchNo" value="${balance.batchNo }">
		    <input type="file" id="uploadFile" name="uploadFile" onchange="uploadImg();" style="display: none;" />
		    <div class="am-u-sm-12 am-u-md-6">
		      <h4><label class="radio-inline">${balance.batchName }</label></h4>
		    </div>
	      </div>
	    </form>
      </div>
            ...
            <table id="dt" class="table table-striped table-bordered table-radius table-hover">
              <thead>
	            <tr>
                  ...
                  <th class="fontWeight_normal tdwidth100">连锁商</th>
                  <th class="fontWeight_normal tdwidth150">负责人</th>
                  <th class="fontWeight_normal tdwidth80">电话</th>
                  <th class="fontWeight_normal ">银行账号</th>
                  <th class="fontWeight_normal tdwidth100">结算金额(元)</th>
                  <th class="fontWeight_normal tdwidth80">打款状态</th>
...
dto.setColumnDefs([
    ...
    {//负责人
        ...
        render: function (data, type, row, meta) {        
        	var html = "";
        	if(row.status == 0){
                html += "<a href='javascript:void(0);' onclick=\"selectFile('"+ row.id +"');\">上传</a>";
            }else{
                html += "<a onclick=\"showImg('"+ row.bankSlipImg +"');\" href='javascript:void(0);' target=\"_blank\">查看</a> ";
                html += " <a href='javascript:void(0);' onclick=\"deleteImg('"+ row.id +"');\">删除</a>";
            }
        	return html;
        }
    },
