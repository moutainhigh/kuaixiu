...
<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
        <ul class="am-list admin-sidebar-list">
            ...
            <%-- 循环输出菜单 --%>
            <c:forEach items="${sysMenuList }" var="menu1" varStatus="j">
                <li class="admin-parent">
                    <a class="am-cf am-collapsed" onclick="func_admin_parent_click(this);"
                       data-am-collapse="{target: '#collapse-nav_${j.index}'}">
                        <span class="${menu1.icon }"></span> ${menu1.name }<span
...
<script type="text/javascript">
    ...
    function func_admin_parent_click_1(obj) {
        if ($(obj).find(".am-fr").hasClass("am-icon-angle-down")) {
            $(obj).find(".am-fr").removeClass("am-icon-angle-down");
            $(obj).find(".am-fr").addClass("am-icon-angle-up");
        } else {
