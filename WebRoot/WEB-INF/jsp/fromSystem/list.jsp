...
<div class="am-cf am-padding am-padding-bottom-0">
    <div class="am-fl am-cf" style="width: 100%;">
        <strong class="am-text-primary am-text-lg">来源系统管理</strong> /
        <small>列表查询</small>
    </div>
</div>
...
<script type="text/javascript">
    ...
    //设置数据刷新路径
    dto.ajax = {
        "url": "${ctx}/fromSystem/queryListForPage.do",
        "data": function (d) {
            //将表单中的查询条件追加到请求参数中
    ...
    function editBtnClick(id) {
        ...
        $("#modal-updateView").load("${ctx}/fromSystem/edit.do?id=" + id, function () {
    ...
    function delBtnClick(id) {
        AlertText.tips("d_confirm", "删除提示", "确定要删除吗？", function () {
            ...
            var url_ = AppConfig.ctx + "/fromSystem/delete.do";
            var data_ = {id: id};
            $.ajax({
                url: url_,
                data: data_,
