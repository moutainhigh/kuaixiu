webpackJsonp([1], {
    NHnr: function (t, e, i) {
            ...
            methods: {
                getcodevalue: function () {
                    ...
                    this.$http({
                        ...
                        console.log(e), "0" == e.data.resultCode && (document.getElementsByClassName("main")[0].style.backgroundColor = "#" + e.data.result.centerImage.centercolorValue, t.headImage = e.data.result.headImage.headUrl, t.centerImage = e.data.result.centerImage.centerUrl, t.activityRole = e.data.result.activityRole)
                    })
        ...
        var c = new d.a({routes: [{path: "/", name: "HelloWorld", component: u}]}), p = i("Au9i"), m = i.n(p),
            f = (i("d8/S"), i("mtWM")), v = i.n(f);
        v.a.defaults.headers.post["Content-Type"] = "application/json", o.default.use(m.a), o.default.config.productionTip = !1, o.default.$toast = o.default.prototype.$toast = p.Toast, o.default.component(p.Header.name, p.Header), o.default.component(p.Popup.name, p.Popup), o.default.component(p.Button.name, p.Button), o.default.component(p.Picker.name, p.Picker), o.default.prototype.$http = v.a, new o.default({
            el: "#app",
            router: c,
            components: {App: l},
            template: "<App/>"
