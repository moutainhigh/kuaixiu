...
var CacheKey = {
    ...
    code:'pay_code',
    //优惠券
    limitBrand:'limit_brand',
    limitProject:'limit_project',
...
var linkUrl=getRealPath();
   // var appId='wx01d86548b43ea2b1';    // 测试公众号
    var appId='wx2f9fa0184228af25';    // 超人真实公众号

//底部菜单
$('.bottom_list li').click(function(){
...
function nearStore() {
    ...
    geolocation.getCurrentPosition(function(r){
        if(this.getStatus() == BMAP_STATUS_SUCCESS){
            var lang = r.point.lng,
                latitude = r.point.lat;
            window.location.href = 'store.html';
            eCacheUtil.storage.cache(CacheKey.lang,lang);
            eCacheUtil.storage.cache(CacheKey.latitude,latitude);
        }
        else {
